...
/**
 * <p>Java class for type.BaseSignificancy complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="type.BaseSignificancy"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Local" type="{http://xml.kishou.go.jp/jmaxml1/body/meteorology1/}type.LocalSignificancy" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "type.BaseSignificancy", propOrder = {
    "significancy",
    "sentence",
    "peakTime",
    "attention",
...
public class TypeBaseSignificancy {
    ...
    protected List<TypeLocalSignificancy> local;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TypeLocalSignificancy }
     * 
     * 
     */
    public List<TypeLocalSignificancy> getLocal() {
        if (local == null) {
            local = new ArrayList<TypeLocalSignificancy>();
        }
        return this.local;
    }
