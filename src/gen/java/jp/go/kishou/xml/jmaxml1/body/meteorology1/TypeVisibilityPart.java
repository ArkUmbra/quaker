...
/**
 * <p>Java class for type.VisibilityPart complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="type.VisibilityPart"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="SubArea" type="{http://xml.kishou.go.jp/jmaxml1/body/meteorology1/}type.SubAreaVisibility" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "type.VisibilityPart", propOrder = {
    "sentence",
    "base",
    "temporary",
    "becoming",
...
public class TypeVisibilityPart {
    ...
    protected List<TypeSubAreaVisibility> subArea;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TypeSubAreaVisibility }
     * 
     * 
     */
    public List<TypeSubAreaVisibility> getSubArea() {
        if (subArea == null) {
            subArea = new ArrayList<TypeSubAreaVisibility>();
        }
        return this.subArea;
    }
