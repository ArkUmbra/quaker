...
/**
 * <p>Java class for type.IntensityPref complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="type.IntensityPref"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Area" type="{http://xml.kishou.go.jp/jmaxml1/body/seismology1/}type.IntensityArea" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "type.IntensityPref", propOrder = {
    "name",
    "code",
    "category",
    "maxInt",
...
public class TypeIntensityPref {
    ...
    protected List<TypeIntensityArea> area;
     ...
     * {@link TypeIntensityArea }
     * 
     * 
     */
    public List<TypeIntensityArea> getArea() {
        if (area == null) {
            area = new ArrayList<TypeIntensityArea>();
        }
        return this.area;
    }
