...
/**
 * <p>Java class for type.SubAreaTemperature complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="type.SubAreaTemperature"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Local" type="{http://xml.kishou.go.jp/jmaxml1/body/meteorology1/}type.LocalTemperature" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "type.SubAreaTemperature", propOrder = {
    "areaName",
    "sentence",
    "base",
    "temporary",
...
public class TypeSubAreaTemperature {
    ...
    protected List<TypeLocalTemperature> local;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TypeLocalTemperature }
     * 
     * 
     */
    public List<TypeLocalTemperature> getLocal() {
        if (local == null) {
            local = new ArrayList<TypeLocalTemperature>();
        }
        return this.local;
    }
