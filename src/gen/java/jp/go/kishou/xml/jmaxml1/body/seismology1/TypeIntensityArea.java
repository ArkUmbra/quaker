...
/**
 * <p>Java class for type.IntensityArea complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="type.IntensityArea"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="City" type="{http://xml.kishou.go.jp/jmaxml1/body/seismology1/}type.IntensityCity" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "type.IntensityArea", propOrder = {
    "name",
    "code",
    "category",
    "maxInt",
...
public class TypeIntensityArea {
    ...
    protected List<TypeIntensityCity> city;
     ...
     * {@link TypeIntensityCity }
     * 
     * 
     */
    public List<TypeIntensityCity> getCity() {
        if (city == null) {
            city = new ArrayList<TypeIntensityCity>();
        }
        return this.city;
    }
